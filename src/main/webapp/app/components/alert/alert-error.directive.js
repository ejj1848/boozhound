(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('boozhoundApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-boozhoundApp-error');
                var entityKey = httpResponse.headers('X-boozhoundApp-params');
                if (errorHeader) {
